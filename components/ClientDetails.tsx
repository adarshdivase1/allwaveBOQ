...
const ClientDetails: React.FC<ClientDetailsProps> = ({ details, onDetailsChange }) => {
  ...
  const inputClass = "mt-1 block w-full bg-slate-700 border border-slate-600 rounded-md shadow-sm py-2 px-3 text-white focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm";
  ...
  return (
    <div className="bg-slate-800 p-6 rounded-lg border border-slate-700">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          <label htmlFor="designEngineer" className="block text-sm font-medium text-slate-300">
            Design Engineer
          </label>
        ...
        <div>
          <label htmlFor="accountManager" className="block text-sm font-medium text-slate-300">
            Account Manager
          </label>
        ...
        <div>
          <label htmlFor="keyClientPersonnel" className="block text-sm font-medium text-slate-300">
        ...
        <div className="md:col-span-2">
            <label htmlFor="keyComments" className="block text-sm font-medium text-slate-300">
